 ...
 * @readonly
 */
const DEFAULT_USER_DATA_PATH = path.join(__dirname, '../../.BlockzieData');
 ...
 */
class BlockzieLink extends Emitter{
    /**
     * Construct a Blockzie link server object.
